 ...
 */var Tt=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};class Et extends ft{constructor(){super(...arguments),this.key="",this.overrideLabel="",this.showLabel=!1,this.showCount=!1,this.showReset=!1,this.resetText="Reset (@count)",this.closed=!1,this.showCountInCollapseLabel=!1,this.preferAttributes=!1,this.urlAlias="",this.optionsOpen=!0,this.facetConfigLoaded=!1,this.showMoreOpen=!1}connectedCallback(){super.connectedCallback(),this.optionsOpen=!this.closed}updated(t){if(this.facetConfigLoaded||!this.context?.responseReady)return;const s=this._getFacetData();s&&(this.urlAlias=s.settings.url_alias,this.showLabel=this._configOrAttribute(s.settings.show_title,this.showLabel),this.showCount=this._configOrAttribute(s.settings.widget.show_numbers,this.showCount),this.showReset=this._configOrAttribute(s.settings.widget.showReset,this.showReset),this.resetText=this._configOrAttribute(s.settings.widget.resetText,this.resetText),this.closed=this._configOrAttribute(s.settings.widget.closed,this.closed),this.optionsOpen=this._configOrAttribute(!s.settings.widget.closed,!this.closed),this.showCountInCollapseLabel=this._configOrAttribute(s.settings.widget.showCountInCollapseLabel,this.showCountInCollapseLabel),this.softLimit=this._configOrAttribute(Number(s?.settings.widget?.soft_limit?.limit),this.softLimit),this.softLimitLessLabel=this._configOrAttribute(s?.settings.widget?.soft_limit?.less_label,this.softLimitLessLabel),this.softLimitMoreLabel=this._configOrAttribute(s?.settings.widget?.soft_limit?.more_label,this.softLimitMoreLabel),this.facetConfigLoaded=!0)}_configOrAttribute(t,s){return this.preferAttributes?s:!("boolean"!=typeof s||!t&&!s)||(void 0!==t?t:s)}_getOptionId(t){const s=t.replace(/\W/g,"-");return`option-${this.uid}-${s}`}_getFacetData(){return this.context?.response?.facets.find((t=>t.key===this.key))}_getLabelElement(){const t=this._getFacetData(),s=this.overrideLabel?this.overrideLabel:t.label,e=`facet-label-${this.uid}`,i=t.active_values&&t.active_values.length>0;return X`<h2
    ...
    `}_handleOptionKeydown(t){" "===t.key&&(t.preventDefault(),t.target.click())}_restoreFocusToFacet(){this.lastFocusedFacetKey&&requestAnimationFrame((()=>{const t=this._getFacetData(),s=this.genUniqId(`${t.key}-${this.safeIdentifier(this.lastFocusedFacetKey)}`),e=this.shadowRoot?.getElementById(s);e&&(e.focus(),this.lastFocusedFacetKey="")}))}render(){if(super.render(),!this.shouldRender())return null;const t=`${this._getFacetData().label} facet filter`;return this.wrapCollapsible(this._getCollapsibleLabelElement(),X`
      ...
      `)}};Mt([P({type:Boolean})],qt.prototype,"useRadios",void 0),Mt([T()],qt.prototype,"filterText",void 0),Mt([T()],qt.prototype,"showAllFacets",void 0),Mt([T()],qt.prototype,"lastFocusedFacetKey",void 0),Mt([T()],qt.prototype,"announceMessage",void 0),qt=Mt([a("facet-checkbox")],qt);var Ft=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Dt=class extends Et{constructor(){super(...arguments),this.selectLabel="Choose an option"}updated(t){if(this.facetConfigLoaded||!this.context?.responseReady)return;super.updated(t);const s=this._getFacetData();this.selectLabel=this._configOrAttribute(s?.settings.widget.selectLabel,this.selectLabel)}applyFacet(t,s,e=!1){s?super.applyFacet(t,s,e):this.clearFacet(t)}_getLabelElementSelect(){const t=this._getFacetData(),s=this.overrideLabel?this.overrideLabel:t.label;return X`<label
    ...
    `}render(){return super.render(),this.shouldRender()?this.wrapCollapsible(this._getCollapsibleLabelElement(),X`${this._getSelectElement()} ${this._getResetElement()}`):null}};Ft([P()],Dt.prototype,"selectLabel",void 0),Dt=Ft([a("facet-dropdown")],Dt);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Ht=(t,s)=>{const e=t._$AN;if(void 0===e)return!1;for(const t of e)t._$AO?.(s,!1),Ht(t,s);return!0},It=t=>{let s,e;do{if(void 0===(s=t._$AM))break;e=s._$AN,e.delete(t),t=s}while(0===e?.size)},Bt=t=>{for(let s;s=t._$AM;t=s){let e=s._$AN;if(void 0===e)s._$AN=e=new Set;else if(e.has(t))break;e.add(t),Wt(s)}};function Nt(t){void 0!==this._$AN?(It(this),this._$AM=t,Bt(this)):this._$AM=t}function zt(t,s=!1,e=0){const i=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(s)if(Array.isArray(i))for(let t=e;t<i.length;t++)Ht(i[t],!1),It(i[t]);else null!=i&&(Ht(i,!1),It(i));else Ht(this,t)}const Wt=t=>{t.type==wt&&(t._$AP??=zt,t._$AQ??=Nt)};class Kt extends St{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,e){super._$AT(t,s,e),Bt(this),this.isConnected=t._$AU}_$AO(t,s=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),s&&(Ht(this,t),It(this))}setValue(t){if((t=>void 0===t.strings)(this.t))this.t._$AI(t,this);else{const s=[...this.t._$AH];s[this.i]=t,this.t._$AI(s,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const Vt=()=>new Jt;class Jt{}const Gt=new WeakMap,Zt=xt(class extends Kt{render(t){return tt}update(t,[s]){const e=s!==this.Y;return e&&void 0!==this.Y&&this.rt(void 0),(e||this.lt!==this.ct)&&(this.Y=s,this.ht=t.options?.host,this.rt(this.ct=t.element)),tt}rt(t){if(this.isConnected||(t=void 0),"function"==typeof this.Y){const s=this.ht??globalThis;let e=Gt.get(s);void 0===e&&(e=new WeakMap,Gt.set(s,e)),void 0!==e.get(this.Y)&&this.Y.call(this.ht,void 0),e.set(this.Y,t),void 0!==t&&this.Y.call(this.ht,t)}else this.Y.value=t}get lt(){return"function"==typeof this.Y?Gt.get(this.ht??globalThis)?.get(this.Y):this.Y?.value}disconnected(){this.lt===this.ct&&this.rt(void 0)}reconnected(){this.rt(this.ct)}});var Qt=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};const Xt=t=>{class s extends t{constructor(){super(...arguments),this.htmlSelectLabel="Choose an option",this.multipleSelect=!1,this.dropdownOpen=!1,this.required=!1,this.focusedOption=null,this.focusOnOpen=!1,this.searchTerm="",this.inputRef=Vt(),this.listboxRef=Vt(),this.selectActions={Close:0,CloseSelect:1,First:2,Last:3,Next:4,Open:5,PageDown:6,PageUp:7,Previous:8,Select:9,Type:10}}updated(t){super.updated(t),this.focusOnOpen&&(this._setOptionFocus(this._getNextOption(this.selectActions.First)),this.focusOnOpen=!1)}getHtmlLabel(){return""}getOptionId(t){const s=this.safeIdentifier(this.getOptionKey(t));return`option-${this.uid}-${s}`}getOptionKey(t){return""}getOptionValue(t){return""}getOptionLabel(t){return""}getAllOptions(){return[]}isOptionSelected(t){return!0}hasSelectedOptions(){return!1}getHtmlSelectLabel(){return this.htmlSelectLabel}optionMouseDown(t,s){t.preventDefault()}clearSelection(t){t.preventDefault()}applySelection(t){}getSelectedOptions(){return[]}filterOptions(t){return[]}_getHtmlLabelElement(){return this.getHtmlLabel()?X`<label id="combo-label-${this.uid}" class="combo-label"
    ...
    `}};ss([P()],es.prototype,"removeText",void 0),ss([P()],es.prototype,"resetText",void 0),ss([P({type:Boolean})],es.prototype,"showReset",void 0),ss([P({type:Boolean})],es.prototype,"showIndividual",void 0),es=ss([a("search-applied-facets")],es);var is=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let rs=class extends ft{constructor(){super(...arguments),this.url="",this.current_query="",this.submitText="Search",this.ariaLabelText="",this.placeHolderText="",this.componentLabelText=""}createRenderRoot(){return this.style.display="block",this}async connectedCallback(){if(super.connectedCallback(),this.context?.query&&this.context?.query.has("q")&&null!=this.context?.query.get("q")?.trim){let t=this.context?.query.get("q")??"";console.log(t),null!=t&&(this.current_query=t)}}_submit(t){if(t.preventDefault(),t.currentTarget instanceof Element){const s=t?.currentTarget?.querySelector("input")?.value?.trim(),e=new URLSearchParams;this.current_query=s||"",e.set("q",s||""),this.getResults(e)}}render(){return X`
 ...
 * SPDX-License-Identifier: BSD-3-Clause
 */
class ds extends St{constructor(t){if(super(t),this.it=tt,t.type!==wt)throw Error(this.constructor.directiveName+"() can only be used in child bindings")}render(t){if(t===tt||null==t)return this._t=void 0,this.it=t;if(t===Y)return t;if("string"!=typeof t)throw Error(this.constructor.directiveName+"() called with a non-string value");if(t===this.it)return this._t;this.it=t;const s=[t];return s.raw=s,this._t={_$litType$:this.constructor.resultType,strings:s,values:[]}}}ds.directiveName="unsafeHTML",ds.resultType=1;const us=xt(ds);var ps=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let bs=class extends ft{constructor(){super(...arguments),this.settings={},this.data={}}render(){return this?.settings?.field&&this.data&&this.data[this?.settings?.field]?X`${us(this.data[this?.settings.field])}`:null}};ps([P({type:Object})],bs.prototype,"settings",void 0),ps([P({type:Object})],bs.prototype,"data",void 0),bs=ps([a("search-result-element-rendered")],bs);var vs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let $s=class extends ft{constructor(){super(...arguments),this.summaryText="@start - @end of @total"}_getNumbers(){const t=this.context?.response?.search_results_page??0,s=parseInt(this.context?.response?.search_results_per_page?this.context?.response.search_results_per_page:this.context?.defaultPerPage),e=this.context?.response?.search_results_count,i=t*s,r={start:0,end:0,total:e};r.start=0===e?0:t*s+1;const n=+i+s;return r.end=n>e?e:n,r}_getSummaryElement(){const t=this._getNumbers();if(0===t.total)return X`Showing 0 results.`;const s=this.context?.response?.took?this.context?.response?.took/1e3:"",e=this.summaryText.replaceAll("@start","Showing "+t.start).replaceAll("@end",""+t.end).replaceAll("@total",t.total+(1===t.total?" result":" results")).replaceAll("@searchQuery",this.context?.query?.get("q")??"").replaceAll("@time",""+s);return X`${e}`}render(){return this.context?.response?X`<div>${this._getSummaryElement()}</div>`:null}};vs([P()],$s.prototype,"summaryText",void 0),$s=vs([a("search-result-summary")],$s);
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const ms=Symbol.for(""),fs=t=>{if(t?.r===ms)return t?._$litStatic$},gs=t=>({_$litStatic$:t,r:ms}),ys=new Map,ws=(t=>(s,...e)=>{const i=e.length;let r,n;const o=[],a=[];let l,h=0,c=!1;for(;h<i;){for(l=s[h];h<i&&void 0!==(n=e[h],r=fs(n));)l+=r+s[++h],c=!0;h!==i&&a.push(n),o.push(l),h++}if(h===i&&o.push(s[i]),c){const t=o.join("$$lit$$");void 0===(s=ys.get(t))&&(o.raw=o,ys.set(t,s=o)),e=a}return t(s,...e)})(X);var xs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ss=class extends ft{constructor(){super(...arguments),this.resultField="",this.mappings=[],this.configLoaded=!1,this.processedMappings={},this.is_standalone=!1}updated(t){!this.configLoaded&&this.context?.responseReady&&(this.resultField||(this.resultField=this.context.response?.swc_results.field??""),0===this.mappings.length&&(this.mappings=this.context.response?.swc_results.mappings??[]),this.mappings.forEach((t=>{t.keys.forEach((s=>{if(this.processedMappings[s]={element:t.element,settings:t.settings},t.settings.is_standalone){"true"==t.settings.is_standalone&&(this.is_standalone=!0)}}))})),this.configLoaded=!0)}_mapResult(t){return this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]?this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]:this.processedMappings[`default-${this.context?.resultDisplay}`]?this.processedMappings[`default-${this.context?.resultDisplay}`]:this.processedMappings[t[this.resultField]]?this.processedMappings[t[this.resultField]]:this.processedMappings.default?this.processedMappings.default:void console.warn("No element mapping found for: ",t)}_getResults(){const t=this.context?.response?.search_results??[];return this.is_standalone?this._getStandaloneResults(t):0===t.length?ws`
        <div
    ...
    `}_getStandaloneResults(t){let s;if(this.context?.query&&this.context?.query.has("q")&&null!=this.context?.query.get("q")?.trim){let t=this.context?.query.get("q")??"";console.log(t),null!=t&&(s=t)}return 0===t.length||null==s?ws`
        <div>
    ...
    `}render(){return this.configLoaded?ws`${this._getResults()} `:null}};xs([P()],Ss.prototype,"resultField",void 0),xs([P({type:Object})],Ss.prototype,"mappings",void 0),xs([T()],Ss.prototype,"configLoaded",void 0),xs([T()],Ss.prototype,"processedMappings",void 0),Ss=xs([a("search-results")],Ss);var ks=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Os=class extends ft{constructor(){super(...arguments),this.settings={},this.data={}}render(){const t=this.settings.id,s=this.settings.title,e=this.settings.thumbnail,i=this.settings.fields,r=this.settings.base_path,n=this?.context?.query?.get("q");let o;t in this.data&&(o=this.data[t].trim(),this.data[t].includes("solr_document")&&(o=this.data[t].replace("solr_document/","")),o=n?o+"?q="+n:o);let a=this.data[s],l=this.data[e],h=!0;const c=Object.entries(i).map((([t,s],e)=>{const i=this.data[s.key];let r="true"==s.is_boolean;if(null==i||""===i||Array.isArray(i)&&0===i.length){if(!r)return null;h=!1}let n=("string"==typeof t&&t||s&&s.label||"").trim();if(!n){n=["Item type:","Collection:","Date:"][e]||""}return{label:"true"==s.show_label?t:n,value:i,field:s,template:"true"==s.show_label?Array.isArray(i)&&null!=s.facet_link_pattern?X` <div class="t-label">
    ...
    `}render(){if(0===this.options.length||!this.context?.response)return null;switch(this.type){case"select":return this._getSelect();case"list":return this._getList();case"html":return this._getHtml()}}getHtmlLabel(){return this.labelText}getOptionKey(t){return t.key?""+t.key:""+t.value}getOptionValue(t){return t.value?""+t.value:""+t.key}getOptionLabel(t){return""+t.label}getAllOptions(){return this.options}isOptionSelected(t){const s=this._getSelected();return!!s&&this.getOptionValue(s)===this.getOptionValue(t)}hasSelectedOptions(){return!!this._getSelected()}getHtmlSelectLabel(){return this._getSelected()?""+this._getSelected()?.label:this.htmlSelectLabel}optionMouseDown(t,s){t.preventDefault(),this._queryPerPage(""+this.getOptionValue(s)),this.close()}applySelection(t){this.focusedOption&&this.focusedOption.dataset.value&&this._queryPerPage(this.focusedOption.dataset.value)}getSelectedOptions(){const t=this._getSelected();return t?[t]:[]}filterOptions(t){return this.getAllOptions().filter((s=>(""+s.label).toLowerCase().startsWith(t)))}};_s([P()],Rs.prototype,"type",void 0),_s([P()],Rs.prototype,"labelText",void 0),_s([P({type:Array})],Rs.prototype,"options",void 0),_s([T()],Rs.prototype,"indexConfigLoaded",void 0),Rs=_s([a("search-results-per-page")],Rs);var Ls=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Cs=class extends ft{constructor(){super(...arguments),this.options=[],this.indexConfigLoaded=!1}updated(t){!this.indexConfigLoaded&&this.context?.responseReady&&(this.indexConfigLoaded=!0,0===this.options.length&&this.context.response?.swc_displays&&(this.options=this.context.response?.swc_displays))}_getOptionElement(t){return ws`<li>
      <button
        name="${t.key}"
    ...
    </ul>`}render(){return ws`${this._getAllOptions()} `}};Ls([P({type:Object})],Cs.prototype,"options",void 0),Ls([T()],Cs.prototype,"indexConfigLoaded",void 0),Cs=Ls([a("search-results-switcher")],Cs);var js=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ps=class extends ft{constructor(){super(...arguments),this.prevLabel="<",this.nextLabel=">",this.showNextPrev=!1,this.showFirstLast=!1,this.firstLabel="First page",this.lastLabel="Last page",this.pagesToDisplay=void 0,this.firstLastPagesToDisplay=0}_changePage(t){const s=new URLSearchParams(this.context?.query?.toString()??"");0!==t?s.set("page",""+t):s.delete("page"),this.getResults(s)}_getCurrentPageElement(){const t=this.context?.response?.search_results_page??0;return ws`<button class="page current" aria-pressed="true">
      ${t+1}
    ...
    `}};Is([T()],Bs.prototype,"context",void 0),Is([P()],Bs.prototype,"searchEndpoint",void 0),Is([P()],Bs.prototype,"resultsCount",void 0),Is([P()],Bs.prototype,"noResultsLink",void 0),Is([P()],Bs.prototype,"noResultsMessage",void 0),Is([P()],Bs.prototype,"blockTitle",void 0),Is([P()],Bs.prototype,"blockDescription",void 0),Is([P()],Bs.prototype,"bottomLinkText",void 0),Is([P()],Bs.prototype,"blockIcon",void 0),Bs=Hs=Is([a("standalone-search-results")],Bs);var Ns=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let zs=class extends ft{render(){return X`
    ...
    `}};zs=Ns([a("search-result-toolbar")],zs);var Ws={BaseSearchElement:ft,SearchRoot:yt,FacetButton:Ut,FacetCheckbox:qt,FacetDropdown:Dt,FacetDropdownHtml:ts,SearchAppliedFacets:es,SearchBox:rs,SearchInput:os,SearchNoResultsMessage:ls,SearchResultElementDefault:cs,SearchResultElementRendered:bs,SearchResultSummary:$s,SearchResults:Ss,SearchResultsPerPage:Rs,SearchResultsSwitcher:Cs,SearchSimplePager:Ps,SearchSort:Es,SearchDialogPane:qs,SearchDialogToggle:Us,SearchResultElementUMDLibraries:Os,SearchShare:Ds,SearchResultToolbar:zs,StandAloneSearchResults:Bs};export{Ws as default};
