 ...
 */var Et=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};class Tt extends mt{constructor(){super(...arguments),this.key="",this.overrideLabel="",this.showLabel=!1,this.showCount=!1,this.showReset=!1,this.resetText="Reset (@count)",this.closed=!1,this.showCountInCollapseLabel=!1,this.preferAttributes=!1,this.urlAlias="",this.optionsOpen=!0,this.facetConfigLoaded=!1,this.showMoreOpen=!1}connectedCallback(){super.connectedCallback(),this.optionsOpen=!this.closed}updated(t){if(this.facetConfigLoaded||!this.context?.responseReady)return;const s=this._getFacetData();s&&(this.urlAlias=s.settings.url_alias,this.showLabel=this._configOrAttribute(s.settings.show_title,this.showLabel),this.showCount=this._configOrAttribute(s.settings.widget.show_numbers,this.showCount),this.showReset=this._configOrAttribute(s.settings.widget.showReset,this.showReset),this.resetText=this._configOrAttribute(s.settings.widget.resetText,this.resetText),this.closed=this._configOrAttribute(s.settings.widget.closed,this.closed),this.optionsOpen=this._configOrAttribute(!s.settings.widget.closed,!this.closed),this.showCountInCollapseLabel=this._configOrAttribute(s.settings.widget.showCountInCollapseLabel,this.showCountInCollapseLabel),this.softLimit=this._configOrAttribute(Number(s?.settings.widget?.soft_limit?.limit),this.softLimit),this.softLimitLessLabel=this._configOrAttribute(s?.settings.widget?.soft_limit?.less_label,this.softLimitLessLabel),this.softLimitMoreLabel=this._configOrAttribute(s?.settings.widget?.soft_limit?.more_label,this.softLimitMoreLabel),this.facetConfigLoaded=!0)}_configOrAttribute(t,s){return this.preferAttributes?s:!("boolean"!=typeof s||!t&&!s)||(void 0!==t?t:s)}_getOptionId(t){const s=t.replace(/\W/g,"-");return`option-${this.uid}-${s}`}_getFacetData(){return this.context?.response?.facets.find((t=>t.key===this.key))}_getLabelElement(){const t=this._getFacetData(),s=this.overrideLabel?this.overrideLabel:t.label,e=`facet-label-${this.uid}`,i=t.active_values&&t.active_values.length>0;return X`<h2
    ...
    >
      ${s}
    </button>`}shouldRender(){return!(!this.context?.response||void 0===this._getFacetData()||0===this._getFacetData().count)}render(){this.classList.add(this.safeIdentifier(this.key));const t=this._getFacetData();t&&t.count?this.classList.add("has-options"):this.classList.remove("has-options"),t&&t.active_values&&t.active_values.length>0?this.classList.add("is-active"):this.classList.remove("is-active"),this.optionsOpen?this.classList.remove("collapsed"):this.classList.add("collapsed")}}Et([P()],Tt.prototype,"key",void 0),Et([P()],Tt.prototype,"overrideLabel",void 0),Et([P({type:Boolean})],Tt.prototype,"showLabel",void 0),Et([P({type:Boolean})],Tt.prototype,"showCount",void 0),Et([P({type:Boolean})],Tt.prototype,"showReset",void 0),Et([P()],Tt.prototype,"resetText",void 0),Et([P({type:Boolean})],Tt.prototype,"closed",void 0),Et([P({type:Boolean})],Tt.prototype,"showCountInCollapseLabel",void 0),Et([P({type:Boolean})],Tt.prototype,"preferAttributes",void 0),Et([P({attribute:!1})],Tt.prototype,"urlAlias",void 0),Et([P({type:Number})],Tt.prototype,"softLimit",void 0),Et([P()],Tt.prototype,"softLimitLessLabel",void 0),Et([P()],Tt.prototype,"softLimitMoreLabel",void 0),Et([E()],Tt.prototype,"optionsOpen",void 0),Et([E()],Tt.prototype,"facetConfigLoaded",void 0),Et([E()],Tt.prototype,"facet",void 0),Et([E()],Tt.prototype,"showMoreOpen",void 0);var At=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ut=class extends Tt{_getOptions(t=void 0){const s=this._getFacetData();let e=t??s.results;return void 0===t&&this.softLimit&&0!==this.softLimit&&!this.showMoreOpen&&(e=e.slice(0,this.softLimit)),X`
      <ul>
    ...
    `}_handleOptionKeydown(t){" "===t.key&&(t.preventDefault(),t.target.click())}_restoreFocusToFacet(){this.lastFocusedFacetKey&&requestAnimationFrame((()=>{const t=this._getFacetData(),s=this.genUniqId(`${t.key}-${this.safeIdentifier(this.lastFocusedFacetKey)}`),e=this.shadowRoot?.getElementById(s);e&&(e.focus(),this.lastFocusedFacetKey="")}))}render(){if(super.render(),!this.shouldRender())return null;const t=`${this._getFacetData().label} facet filter`;return this.wrapCollapsible(this._getCollapsibleLabelElement(),X`
      ...
      `)}};Mt([P({type:Boolean})],Ft.prototype,"useRadios",void 0),Mt([E()],Ft.prototype,"filterText",void 0),Mt([E()],Ft.prototype,"showAllFacets",void 0),Mt([E()],Ft.prototype,"lastFocusedFacetKey",void 0),Mt([E()],Ft.prototype,"announceMessage",void 0),Ft=Mt([h("facet-checkbox")],Ft);var qt=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Dt=class extends Tt{constructor(){super(...arguments),this.selectLabel="Choose an option"}updated(t){if(this.facetConfigLoaded||!this.context?.responseReady)return;super.updated(t);const s=this._getFacetData();this.selectLabel=this._configOrAttribute(s?.settings.widget.selectLabel,this.selectLabel)}applyFacet(t,s,e=!1){s?super.applyFacet(t,s,e):this.clearFacet(t)}_getLabelElementSelect(){const t=this._getFacetData(),s=this.overrideLabel?this.overrideLabel:t.label;return X`<label
    ...
    `}render(){return super.render(),this.shouldRender()?this.wrapCollapsible(this._getCollapsibleLabelElement(),X`${this._getSelectElement()} ${this._getResetElement()}`):null}};qt([P()],Dt.prototype,"selectLabel",void 0),Dt=qt([h("facet-dropdown")],Dt);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */
const Bt=(t,s)=>{const e=t._$AN;if(void 0===e)return!1;for(const t of e)t._$AO?.(s,!1),Bt(t,s);return!0},Ht=t=>{let s,e;do{if(void 0===(s=t._$AM))break;e=s._$AN,e.delete(t),t=s}while(0===e?.size)},Nt=t=>{for(let s;s=t._$AM;t=s){let e=s._$AN;if(void 0===e)s._$AN=e=new Set;else if(e.has(t))break;e.add(t),Kt(s)}};function It(t){void 0!==this._$AN?(Ht(this),this._$AM=t,Nt(this)):this._$AM=t}function Wt(t,s=!1,e=0){const i=this._$AH,r=this._$AN;if(void 0!==r&&0!==r.size)if(s)if(Array.isArray(i))for(let t=e;t<i.length;t++)Bt(i[t],!1),Ht(i[t]);else null!=i&&(Bt(i,!1),Ht(i));else Bt(this,t)}const Kt=t=>{t.type==wt&&(t._$AP??=Wt,t._$AQ??=It)};class zt extends xt{constructor(){super(...arguments),this._$AN=void 0}_$AT(t,s,e){super._$AT(t,s,e),Nt(this),this.isConnected=t._$AU}_$AO(t,s=!0){t!==this.isConnected&&(this.isConnected=t,t?this.reconnected?.():this.disconnected?.()),s&&(Bt(this,t),Ht(this))}setValue(t){if((t=>void 0===t.strings)(this.t))this.t._$AI(t,this);else{const s=[...this.t._$AH];s[this.i]=t,this.t._$AI(s,this,0)}}disconnected(){}reconnected(){}}
/**
 * @license
 * Copyright 2020 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const fs=Symbol.for(""),ms=t=>{if(t?.r===fs)return t?._$litStatic$},gs=new Map,ys=(t=>(s,...e)=>{const i=e.length;let r,n;const o=[],h=[];let l,a=0,c=!1;for(;a<i;){for(l=s[a];a<i&&void 0!==(n=e[a],r=ms(n));)l+=r+s[++a],c=!0;a!==i&&h.push(n),o.push(l),a++}if(a===i&&o.push(s[i]),c){const t=o.join("$$lit$$");void 0===(s=gs.get(t))&&(o.raw=o,gs.set(t,s=o)),e=h}return t(s,...e)})(X);var ws=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ss=class extends mt{constructor(){super(...arguments),this.resultField="",this.mappings=[],this.configLoaded=!1,this.processedMappings={}}updated(t){!this.configLoaded&&this.context?.responseReady&&(this.resultField||(this.resultField=this.context.response?.swc_results.field??""),0===this.mappings.length&&(this.mappings=this.context.response?.swc_results.mappings??[]),this.mappings.forEach((t=>{t.keys.forEach((s=>{this.processedMappings[s]={element:t.element,settings:t.settings}}))})),this.configLoaded=!0)}_mapResult(t){return this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]?this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]:this.processedMappings[`default-${this.context?.resultDisplay}`]?this.processedMappings[`default-${this.context?.resultDisplay}`]:this.processedMappings[t[this.resultField]]?this.processedMappings[t[this.resultField]]:this.processedMappings.default?this.processedMappings.default:void console.warn("No element mapping found for: ",t)}_getResults(){const t=this.context?.response?.search_results??[];return 0===t.length?null:ys`
    ...
    `}render(){return this.configLoaded?ys`${this._getResults()} `:null}};ws([P()],Ss.prototype,"resultField",void 0),ws([P({type:Object})],Ss.prototype,"mappings",void 0),ws([E()],Ss.prototype,"configLoaded",void 0),ws([E()],Ss.prototype,"processedMappings",void 0),Ss=ws([h("search-results")],Ss);var xs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Os=class extends mt{constructor(){super(...arguments),this.settings={},this.data={}}render(){const t=this.settings.id,s=this.settings.title,e=this.settings.thumbnail,i=this.settings.fields,r=this.settings.base_path,n=this?.context?.query?.get("q");let o;t in this.data&&(o=this.data[t].trim(),this.data[t].includes("solr_document")&&(o=this.data[t].replace("solr_document/","")),o=n?o+"?q="+n:o);let h=this.data[s],l=this.data[e];const a=Object.entries(i).map((([t,s],e)=>{const i=this.data[s.key];if(null==i||""===i||Array.isArray(i)&&0===i.length)return tt;let r="";return 0===e?r="Item type:":1===e?r="Collection:":2===e&&(r="Date:"),s.show_label&&"true"==s.show_label?X`<div class="t-label">
    ...
    `}};xs([P({type:Object})],Os.prototype,"settings",void 0),xs([P({attribute:!0,type:Object})],Os.prototype,"data",void 0),Os=xs([h("search-result-element-umd-libraries")],Os);var ks=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let _s=class extends(Xt(mt)){constructor(){super(...arguments),this.required=!0,this.type="select",this.labelText="Per page",this.options=[],this.indexConfigLoaded=!1}updated(t){!this.indexConfigLoaded&&this.context?.responseReady&&(this.indexConfigLoaded=!0,0===this.options.length&&this.context.response?.swc_page_sizes&&(this.options=this.context.response?.swc_page_sizes))}_queryPerPage(t){const s=new URLSearchParams(this.context?.query?.toString()??""),e=""+this?.context?.defaultPerPage,i=""+this?.context?.response?.search_results_per_page;t?s.set("limit",t):s.set("limit",e),t!==i&&s.delete("page"),t===e&&s.delete("limit"),this.getResults(s)}_getSelected(){const t=""+this?.context?.defaultPerPage,s=""+this?.context?.response?.search_results_per_page;let e=this.options.find((s=>s.key===t));return this.context?.response?.search_results_per_page&&(e=this.options.find((t=>t.key===s))),e}_getSelectOption(){return X` ${Pt(this.options,(t=>t.key),(t=>X`<option
          value=${t.key}
    ...
    `}render(){if(0===this.options.length||!this.context?.response)return null;switch(this.type){case"select":return this._getSelect();case"list":return this._getList();case"html":return this._getHtml()}}getHtmlLabel(){return this.labelText}getOptionKey(t){return t.key?""+t.key:""+t.value}getOptionValue(t){return t.value?""+t.value:""+t.key}getOptionLabel(t){return""+t.label}getAllOptions(){return this.options}isOptionSelected(t){const s=this._getSelected();return!!s&&this.getOptionValue(s)===this.getOptionValue(t)}hasSelectedOptions(){return!!this._getSelected()}getHtmlSelectLabel(){return this._getSelected()?""+this._getSelected()?.label:this.htmlSelectLabel}optionMouseDown(t,s){t.preventDefault(),this._queryPerPage(""+this.getOptionValue(s)),this.close()}applySelection(t){this.focusedOption&&this.focusedOption.dataset.value&&this._queryPerPage(this.focusedOption.dataset.value)}getSelectedOptions(){const t=this._getSelected();return t?[t]:[]}filterOptions(t){return this.getAllOptions().filter((s=>(""+s.label).toLowerCase().startsWith(t)))}};ks([P()],_s.prototype,"type",void 0),ks([P()],_s.prototype,"labelText",void 0),ks([P({type:Array})],_s.prototype,"options",void 0),ks([E()],_s.prototype,"indexConfigLoaded",void 0),_s=ks([h("search-results-per-page")],_s);var Ls=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Cs=class extends mt{constructor(){super(...arguments),this.options=[],this.indexConfigLoaded=!1}updated(t){!this.indexConfigLoaded&&this.context?.responseReady&&(this.indexConfigLoaded=!0,0===this.options.length&&this.context.response?.swc_displays&&(this.options=this.context.response?.swc_displays))}_getOptionElement(t){return ys`<li>
      <button
        name="${t.key}"
    ...
    </ul>`}render(){return ys`${this._getAllOptions()} `}};Ls([P({type:Object})],Cs.prototype,"options",void 0),Ls([E()],Cs.prototype,"indexConfigLoaded",void 0),Cs=Ls([h("search-results-switcher")],Cs);var js=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Rs=class extends mt{constructor(){super(...arguments),this.prevLabel="<",this.nextLabel=">",this.showNextPrev=!1,this.showFirstLast=!1,this.firstLabel="First page",this.lastLabel="Last page",this.pagesToDisplay=void 0,this.firstLastPagesToDisplay=0}_changePage(t){const s=new URLSearchParams(this.context?.query?.toString()??"");0!==t?s.set("page",""+t):s.delete("page"),this.getResults(s)}_getCurrentPageElement(){const t=this.context?.response?.search_results_page??0;return ys`<button class="page current" aria-pressed="true">
      ${t+1}
    ...
    `}render(){if(0===this.sorts.length||!this.context?.response)return null;switch(this.type){case"select":return this._getSelect();case"list":return this._getList();case"html":return this._getHtml();case"umd-libraries":return this._getCustom()}}getHtmlLabel(){return this.labelText}getOptionKey(t){return`${t.key}-${t.order}`}getOptionValue(t){return`${t.key}|${t.order}`}getOptionLabel(t){return""+t.label}getAllOptions(){return this.sorts}isOptionSelected(t){const s=this._getSelected();return!!s&&this.getOptionValue(s)===this.getOptionValue(t)}hasSelectedOptions(){return!!this._getSelected()}getHtmlSelectLabel(){return this._getSelected()?""+this._getSelected()?.label:this.htmlSelectLabel}optionMouseDown(t,s){t.preventDefault(),this._querySort(s.key,s.order),this.close()}applySelection(t){if(this.focusedOption&&this.focusedOption.dataset.value){const[t,s]=this.focusedOption.dataset.value.split("|");this._querySort(t,s)}}getSelectedOptions(){const t=this._getSelected();return t?[t]:[]}filterOptions(t){return this.getAllOptions().filter((s=>(""+s.label).toLowerCase().startsWith(t)))}};Ps([P()],Es.prototype,"type",void 0),Ps([P()],Es.prototype,"labelText",void 0),Ps([P({type:Array})],Es.prototype,"sorts",void 0),Ps([P({type:Object})],Es.prototype,"umd_sorts",void 0),Ps([E()],Es.prototype,"indexConfigLoaded",void 0),Es=Ps([h("search-sort")],Es);var Ts=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let As=class extends mt{constructor(){super(...arguments),this.aboveBreakpointText="Filters",this.dialogOpenText="Filters",this.dialogCloseText="Close",this.showAppliedCount=!1,this.showButton=!1}connectedCallback(){super.connectedCallback(),window.addEventListener("resize",(()=>{this._handleResize()}))}disconnectedCallback(){window.removeEventListener("resize",(()=>{this._handleResize()})),super.disconnectedCallback()}updated(t){super.updated(t),this._handleResize()}_handleResize(){this.context?.dialogBreakpoint&&(-1===this.context?.dialogBreakpoint||window.innerWidth<=this.context.dialogBreakpoint)?this.showButton=!0:this.showButton=!1}_getLabelText(){return this.showButton?X`${this.context?.dialogOpen?this.dialogCloseText:this.dialogOpenText}`:X`${this.aboveBreakpointText}`}render(){return void 0!==this.context&&this.context.responseReady?this.showButton?X`
          <button
    ...
    `}};Fs([P()],qs.prototype,"queryText",void 0),qs=Fs([h("search-share")],qs);var Ds=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Bs=class extends mt{render(){return X`
    ...
    `}};Bs=Ds([h("search-result-toolbar")],Bs);var Hs={BaseSearchElement:mt,SearchRoot:yt,FacetButton:Ut,FacetCheckbox:Ft,FacetDropdown:Dt,FacetDropdownHtml:ts,SearchAppliedFacets:es,SearchBox:rs,SearchInput:os,SearchNoResultsMessage:ls,SearchResultElementDefault:cs,SearchResultElementRendered:bs,SearchResultSummary:$s,SearchResults:Ss,SearchResultsPerPage:_s,SearchResultsSwitcher:Cs,SearchSimplePager:Rs,SearchSort:Es,SearchDialogPane:Ms,SearchDialogToggle:As,SearchResultElementUMDLibraries:Os,SearchShare:qs,SearchResultToolbar:Bs};export{Hs as default};
