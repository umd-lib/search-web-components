...
const fs=Symbol.for(""),ms=t=>{if(t?.r===fs)return t?._$litStatic$},gs=new Map,ys=(t=>(s,...e)=>{const i=e.length;let r,n;const o=[],h=[];let l,a=0,c=!1;for(;a<i;){for(l=s[a];a<i&&void 0!==(n=e[a],r=ms(n));)l+=r+s[++a],c=!0;a!==i&&h.push(n),o.push(l),a++}if(a===i&&o.push(s[i]),c){const t=o.join("$$lit$$");void 0===(s=gs.get(t))&&(o.raw=o,gs.set(t,s=o)),e=h}return t(s,...e)})(X);var ws=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ss=class extends mt{constructor(){super(...arguments),this.resultField="",this.mappings=[],this.configLoaded=!1,this.processedMappings={}}updated(t){!this.configLoaded&&this.context?.responseReady&&(this.resultField||(this.resultField=this.context.response?.swc_results.field??""),0===this.mappings.length&&(this.mappings=this.context.response?.swc_results.mappings??[]),this.mappings.forEach((t=>{t.keys.forEach((s=>{this.processedMappings[s]={element:t.element,settings:t.settings}}))})),this.configLoaded=!0)}_mapResult(t){return this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]?this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]:this.processedMappings[`default-${this.context?.resultDisplay}`]?this.processedMappings[`default-${this.context?.resultDisplay}`]:this.processedMappings[t[this.resultField]]?this.processedMappings[t[this.resultField]]:this.processedMappings.default?this.processedMappings.default:void console.warn("No element mapping found for: ",t)}_getResults(){const t=this.context?.response?.search_results??[];return 0===t.length?ys`
    ...
    `}render(){return this.configLoaded?ys`${this._getResults()} `:null}};ws([P()],Ss.prototype,"resultField",void 0),ws([P({type:Object})],Ss.prototype,"mappings",void 0),ws([T()],Ss.prototype,"configLoaded",void 0),ws([T()],Ss.prototype,"processedMappings",void 0),Ss=ws([h("search-results")],Ss);var xs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Os=class extends mt{constructor(){super(...arguments),this.settings={},this.data={}}render(){const t=this.settings.id,s=this.settings.title,e=this.settings.thumbnail,i=this.settings.fields,r=this.settings.base_path,n=this?.context?.query?.get("q");let o;t in this.data&&(o=this.data[t].trim(),this.data[t].includes("solr_document")&&(o=this.data[t].replace("solr_document/","")),o=n?o+"?q="+n:o);let h=this.data[s],l=this.data[e];const a=Object.entries(i).map((([t,s],e)=>{const i=this.data[s.key];if(null==i||""===i||Array.isArray(i)&&0===i.length)return tt;let r="";return 0===e?r="Item type:":1===e?r="Collection:":2===e&&(r="Date:"),s.show_label&&"true"==s.show_label?X`<div class="t-label">
          ...
          <dd>${i}</dd>
        </div>`}));Array.isArray(h)&&(h=h.map((t=>t.startsWith("[@")?t.split("]")[1]:t)),h=h.join(" | ")),Array.isArray(l)&&(l=l[0]);const c=Object.values(i)[0]?.key,d=c?this.data[c]:"";return X`
      <article>
    ...
    `}render(){if(0===this.options.length||!this.context?.response)return null;switch(this.type){case"select":return this._getSelect();case"list":return this._getList();case"html":return this._getHtml()}}getHtmlLabel(){return this.labelText}getOptionKey(t){return t.key?""+t.key:""+t.value}getOptionValue(t){return t.value?""+t.value:""+t.key}getOptionLabel(t){return""+t.label}getAllOptions(){return this.options}isOptionSelected(t){const s=this._getSelected();return!!s&&this.getOptionValue(s)===this.getOptionValue(t)}hasSelectedOptions(){return!!this._getSelected()}getHtmlSelectLabel(){return this._getSelected()?""+this._getSelected()?.label:this.htmlSelectLabel}optionMouseDown(t,s){t.preventDefault(),this._queryPerPage(""+this.getOptionValue(s)),this.close()}applySelection(t){this.focusedOption&&this.focusedOption.dataset.value&&this._queryPerPage(this.focusedOption.dataset.value)}getSelectedOptions(){const t=this._getSelected();return t?[t]:[]}filterOptions(t){return this.getAllOptions().filter((s=>(""+s.label).toLowerCase().startsWith(t)))}};ks([P()],_s.prototype,"type",void 0),ks([P()],_s.prototype,"labelText",void 0),ks([P({type:Array})],_s.prototype,"options",void 0),ks([T()],_s.prototype,"indexConfigLoaded",void 0),_s=ks([h("search-results-per-page")],_s);var Rs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ls=class extends mt{constructor(){super(...arguments),this.options=[],this.indexConfigLoaded=!1}updated(t){!this.indexConfigLoaded&&this.context?.responseReady&&(this.indexConfigLoaded=!0,0===this.options.length&&this.context.response?.swc_displays&&(this.options=this.context.response?.swc_displays))}_getOptionElement(t){return ys`<li>
      <button
        name="${t.key}"
    ...
    </ul>`}render(){return ys`${this._getAllOptions()} `}};Rs([P({type:Object})],Ls.prototype,"options",void 0),Rs([T()],Ls.prototype,"indexConfigLoaded",void 0),Ls=Rs([h("search-results-switcher")],Ls);var Cs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let js=class extends mt{constructor(){super(...arguments),this.prevLabel="<",this.nextLabel=">",this.showNextPrev=!1,this.showFirstLast=!1,this.firstLabel="First page",this.lastLabel="Last page",this.pagesToDisplay=void 0,this.firstLastPagesToDisplay=0}_changePage(t){const s=new URLSearchParams(this.context?.query?.toString()??"");0!==t?s.set("page",""+t):s.delete("page"),this.getResults(s)}_getCurrentPageElement(){const t=this.context?.response?.search_results_page??0;return ys`<button class="page current" aria-pressed="true">
      ${t+1}
    ...
    `}};qs([P()],Ds.prototype,"queryText",void 0),Ds=qs([h("search-share")],Ds);var Fs,Hs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ns=Fs=class extends vt{constructor(){super(...arguments),this.context={url:"",query:new URLSearchParams(window.location.search),responseReady:!1,resultsCount:"5",response:{total:0,page:0,per_page:0,no_results_link:"",module_link:"",query:"",endpoint:"",results:[]}},this.searchEndpoint="",this.resultsCount="5",this.noResultsLink="",this.blockTitle="",this.blockDescription="",this.bottomLinkText="",this.blockIcon="",this.root=new n}createRenderRoot(){return this.style.display="block",this}async connectedCallback(){super.connectedCallback();const t={...this.context};let s;if(document.addEventListener("update-context",(t=>{const s=decodeURIComponent(t.context.query.toString()),e=new URLSearchParams(s);e.has("q")&&null!=e.get("q")?.trim&&this.getResults(e)})),this.searchEndpoint){const[e,i]=this.searchEndpoint.split("?");e.startsWith("/")?t.url=new URL(e,document.baseURI).href:t.url=e,i&&(s=new URLSearchParams(i))}if(t.resultsCount=this.resultsCount,t.query||(t.query=new URLSearchParams),s){let e=!0;const i=["q","per_page"];t.query.forEach(((t,s)=>{i.includes(s)&&""!==t&&(e=!1)})),(0===t.query.size||e)&&(t.query=s,this.context.query=s)}if(0==t.query.size)return;let e=t.query;e.set("per_page",this.resultsCount),t.response=await Fs.doSearch(t.url??"",e),t.responseReady=!0,this.context=t,this.addEventListener("update-context",(t=>{this.context={...this.context,...t.context}}))}async getResults(t){const s={...this.context};s.query=t;let e=t;[s.response]=await Promise.all([Fs.doSearch(s.url??"",e)]),this.context={...s}}static async doSearch(t,s){const e=new URLSearchParams(s.toString());let i=0;for(const[t,r]of s.entries()){if(!t.startsWith("f["))continue;e.delete(t);let s=t.replace("f[","");s=s.substring(0,s.length-1),e.append(`f[${i}]`,`${s}:${r}`),i++}const r=new URL(t);return r.search=e.toString(),Fs.doFetch(r,void 0).then((t=>t))}static async doFetch(t,s=void 0){const e=new Headers(s);return fetch(t,{headers:e,cache:"no-store"}).then((async t=>{const s=await t.text();if(!t.ok)throw new Error(`HTTP error! Status: ${t.status}. Message:${s}`);return Promise.resolve(JSON.parse(s))})).catch((t=>console.error("Error in fetching:",t)))}render(){const t=this.context.response.results,s=this.context.response.total,e=this.bottomLinkText.replace("%total%",s.toString()),i=[];return t.forEach((function(t){const s=t,e=s.extra,r=s.title,n=s.link,o=s.item_format,h=s.description,l=s.author,a=s.availability,c=s.date;i.push(X`
        <li class="search-result s-margin-general-medium">
          <article>
            <div class="item-detail">
              ${r?X`<h2 class="item-title t-title-small s-stack-small">
                    ${n?X` <a href="${n}"
      ...
      `)})),i.length>0?X`
        <div>
          ...
          <footer>
            <p><a href="${this.context.response.module_link}">${e}</a></p>
          </footer>
        </div>
      `:X`
        <div>
      ...
      `}};Hs([T()],Ns.prototype,"context",void 0),Hs([P()],Ns.prototype,"searchEndpoint",void 0),Hs([P()],Ns.prototype,"resultsCount",void 0),Hs([P()],Ns.prototype,"noResultsLink",void 0),Hs([P()],Ns.prototype,"blockTitle",void 0),Hs([P()],Ns.prototype,"blockDescription",void 0),Hs([P()],Ns.prototype,"bottomLinkText",void 0),Hs([P()],Ns.prototype,"blockIcon",void 0),Ns=Fs=Hs([h("standalone-search-results")],Ns);var Bs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,h=t.length-1;h>=0;h--)(r=t[h])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Is=class extends mt{render(){return X`
    ...
    `}};Is=Bs([h("search-result-toolbar")],Is);var Ws={BaseSearchElement:mt,SearchRoot:yt,FacetButton:Ut,FacetCheckbox:qt,FacetDropdown:Ft,FacetDropdownHtml:ts,SearchAppliedFacets:es,SearchBox:rs,SearchInput:os,SearchNoResultsMessage:ls,SearchResultElementDefault:cs,SearchResultElementRendered:bs,SearchResultSummary:$s,SearchResults:Ss,SearchResultsPerPage:_s,SearchResultsSwitcher:Ls,SearchSimplePager:js,SearchSort:Ts,SearchDialogPane:Ms,SearchDialogToggle:As,SearchResultElementUMDLibraries:Os,SearchShare:Ds,SearchResultToolbar:Is,StandAloneSearchResults:Ns};export{Ws as default};
