 ...
 */var Tt=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};class Et extends mt{constructor(){super(...arguments),this.key="",this.overrideLabel="",this.showLabel=!1,this.showCount=!1,this.showReset=!1,this.resetText="Reset (@count)",this.closed=!1,this.showCountInCollapseLabel=!1,this.preferAttributes=!1,this.urlAlias="",this.optionsOpen=!0,this.facetConfigLoaded=!1,this.showMoreOpen=!1}connectedCallback(){super.connectedCallback(),this.optionsOpen=!this.closed}updated(t){if(this.facetConfigLoaded||!this.context?.responseReady)return;const s=this._getFacetData();s&&(this.urlAlias=s.settings.url_alias,this.showLabel=this._configOrAttribute(s.settings.show_title,this.showLabel),this.showCount=this._configOrAttribute(s.settings.widget.show_numbers,this.showCount),this.showReset=this._configOrAttribute(s.settings.widget.showReset,this.showReset),this.resetText=this._configOrAttribute(s.settings.widget.resetText,this.resetText),this.closed=this._configOrAttribute(s.settings.widget.closed,this.closed),this.optionsOpen=this._configOrAttribute(!s.settings.widget.closed,!this.closed),this.showCountInCollapseLabel=this._configOrAttribute(s.settings.widget.showCountInCollapseLabel,this.showCountInCollapseLabel),this.softLimit=this._configOrAttribute(Number(s?.settings.widget?.soft_limit?.limit),this.softLimit),this.softLimitLessLabel=this._configOrAttribute(s?.settings.widget?.soft_limit?.less_label,this.softLimitLessLabel),this.softLimitMoreLabel=this._configOrAttribute(s?.settings.widget?.soft_limit?.more_label,this.softLimitMoreLabel),this.facetConfigLoaded=!0)}_configOrAttribute(t,s){return this.preferAttributes?s:!("boolean"!=typeof s||!t&&!s)||(void 0!==t?t:s)}_getOptionId(t){const s=t.replace(/\W/g,"-");return`option-${this.uid}-${s}`}_getFacetData(){return this.context?.response?.facets.find((t=>t.key===this.key))}_getLabelElement(){const t=this._getFacetData(),s=this.overrideLabel?this.overrideLabel:t.label,e=`facet-label-${this.uid}`,i=t.active_values&&t.active_values.length>0;return X`<h2
    ...
    `}render(){return super.render(),this.shouldRender()?this.wrapCollapsible(this._getCollapsibleLabelElement(),X`${this._getSelectElement()} ${this._getResetElement()}`):null}};Dt([P()],Ft.prototype,"selectLabel",void 0),Ft=Dt([a("facet-dropdown")],Ft);
/**
 * @license
 * Copyright 2017 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
...
const fs=Symbol.for(""),ms=t=>{if(t?.r===fs)return t?._$litStatic$},gs=t=>({_$litStatic$:t,r:fs}),ys=new Map,ws=(t=>(s,...e)=>{const i=e.length;let r,n;const o=[],a=[];let l,h=0,c=!1;for(;h<i;){for(l=s[h];h<i&&void 0!==(n=e[h],r=ms(n));)l+=r+s[++h],c=!0;h!==i&&a.push(n),o.push(l),h++}if(h===i&&o.push(s[i]),c){const t=o.join("$$lit$$");void 0===(s=ys.get(t))&&(o.raw=o,ys.set(t,s=o)),e=a}return t(s,...e)})(X);var xs=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Ss=class extends mt{constructor(){super(...arguments),this.resultField="",this.mappings=[],this.configLoaded=!1,this.processedMappings={},this.is_standalone=!1,this.standalone_icon=""}updated(t){!this.configLoaded&&this.context?.responseReady&&(this.resultField||(this.resultField=this.context.response?.swc_results.field??""),0===this.mappings.length&&(this.mappings=this.context.response?.swc_results.mappings??[]),this.mappings.forEach((t=>{t.keys.forEach((s=>{if(this.processedMappings[s]={element:t.element,settings:t.settings},t.settings.is_standalone){"true"==t.settings.is_standalone&&(this.is_standalone=!0)}if(t.settings.standalone_icon){let s=t.settings.standalone_icon;null!=s&&""!=s&&(this.standalone_icon=s)}}))})),this.configLoaded=!0)}_mapResult(t){return this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]?this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]:this.processedMappings[`default-${this.context?.resultDisplay}`]?this.processedMappings[`default-${this.context?.resultDisplay}`]:this.processedMappings[t[this.resultField]]?this.processedMappings[t[this.resultField]]:this.processedMappings.default?this.processedMappings.default:void console.warn("No element mapping found for: ",t)}_getResults(){const t=this.context?.response?.search_results??[];if(this.is_standalone){const s=this.context?.response?.search_results_count??0;return this._getStandaloneResults(t,s)}return 0===t.length?ws`
    ...
    `}render(){return this.configLoaded?ws`${this._getResults()} `:null}};xs([P()],Ss.prototype,"resultField",void 0),xs([P({type:Object})],Ss.prototype,"mappings",void 0),xs([T()],Ss.prototype,"configLoaded",void 0),xs([T()],Ss.prototype,"processedMappings",void 0),Ss=xs([a("search-results")],Ss);var ks=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let Os=class extends mt{constructor(){super(...arguments),this.settings={},this.data={}}render(){const t=this.settings.id,s=this.settings.title,e=this.settings.thumbnail,i=this.settings.fields,r=this.settings.base_path,n=this?.context?.query?.get("q");let o;t in this.data&&(o=this.data[t].trim(),this.data[t].includes("solr_document")&&(o=this.data[t].replace("solr_document/","")),o=n?o+"?q="+n:o);let a=this.data[s],l=this.data[e],h=!0;const c=Object.entries(i).map((([t,s],e)=>{let i=this.data[s.key],r="true"==s.is_boolean;if(null==i||""===i||Array.isArray(i)&&0===i.length){if(!r)return null;h=!1}let n=("string"==typeof t&&t||s&&s.label||"").trim();if(!n){n=["Item type:","Collection:","Date:"][e]||""}"Excerpt"==n&&(i=i.replace(/\|n[^\s]*/g," "));return{label:"true"==s.show_label?t:n,value:i,field:s,template:"true"==s.show_label?Array.isArray(i)&&null!=s.facet_link_pattern?X` <div class="t-label">
                    ...
                    <dt class="t-bold">${t}:</dt>
                    <dd>${r?X`${1==h?s.boolean_true:s.boolean_false}`:us(i)}</dd>
                  </div>`:Array.isArray(i)?X`<div class="t-label">
                  <dt class="t-bold">${n}</dt>
                  <dd>${Pt(i,(t=>t),((t,s)=>X`${t}${s<i.length-1?", ":""}`))}</dd>
                </div>`:X`<div class="t-label">
                    <dt class="t-bold">${t}:</dt>
                    <dd>${r?X`${1==h?s.boolean_true:s.boolean_false}`:us(i)}</dd>
      ...
      <article>
        <div class="item-detail">
          ${r&&o?X`
              ...
              `:d?X`
                <h2 class="item-title t-title-small s-stack-small">
                  ${Array.isArray(d.value)?d.field.facet_link_pattern?Pt(d.value,(t=>t),(t=>X`
                              <a
                              ...
                              >
                                ...
                                ${t}</a
                              >
                            `)):Pt(d.value,(t=>t),(t=>X`${d.label}${d.label?": ":""}${t}`)):us(d.value)}
                </h2>
              `:""}
    ...
    `}};Hs([T()],Bs.prototype,"context",void 0),Hs([P()],Bs.prototype,"searchEndpoint",void 0),Hs([P()],Bs.prototype,"resultsCount",void 0),Hs([P()],Bs.prototype,"noResultsLink",void 0),Hs([P()],Bs.prototype,"noResultsMessage",void 0),Hs([P()],Bs.prototype,"blockTitle",void 0),Hs([P()],Bs.prototype,"blockDescription",void 0),Hs([P()],Bs.prototype,"bottomLinkText",void 0),Hs([P()],Bs.prototype,"blockIcon",void 0),Hs([P()],Bs.prototype,"blockID",void 0),Bs=Is=Hs([a("standalone-search-results")],Bs);var Ns=function(t,s,e,i){for(var r,n=arguments.length,o=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,a=t.length-1;a>=0;a--)(r=t[a])&&(o=(n<3?r(o):n>3?r(s,e,o):r(s,e))||o);return n>3&&o&&Object.defineProperty(s,e,o),o};let zs=class extends mt{render(){return X`
