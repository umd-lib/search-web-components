...
const $s=Symbol.for(""),gs=t=>{if(t?.r===$s)return t?._$litStatic$},ms=new Map,ws=(t=>(s,...e)=>{const i=e.length;let h,n;const r=[],o=[];let l,c=0,a=!1;for(;c<i;){for(l=s[c];c<i&&void 0!==(n=e[c],h=gs(n));)l+=h+s[++c],a=!0;c!==i&&o.push(n),r.push(l),c++}if(c===i&&r.push(s[i]),a){const t=r.join("$$lit$$");void 0===(s=ms.get(t))&&(r.raw=r,ms.set(t,s=r)),e=o}return t(s,...e)})(X);var ys=function(t,s,e,i){for(var h,n=arguments.length,r=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,o=t.length-1;o>=0;o--)(h=t[o])&&(r=(n<3?h(r):n>3?h(s,e,r):h(s,e))||r);return n>3&&r&&Object.defineProperty(s,e,r),r};let Ss=class extends gt{constructor(){super(...arguments),this.resultField="",this.mappings=[],this.configLoaded=!1,this.processedMappings={}}updated(t){!this.configLoaded&&this.context?.responseReady&&(this.resultField||(this.resultField=this.context.response?.swc_results.field??""),0===this.mappings.length&&(this.mappings=this.context.response?.swc_results.mappings??[]),this.mappings.forEach((t=>{t.keys.forEach((s=>{this.processedMappings[s]={element:t.element,settings:t.settings}}))})),this.configLoaded=!0)}_mapResult(t){return this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]?this.processedMappings[`${t[this.resultField]}-${this.context?.resultDisplay}`]:this.processedMappings[`default-${this.context?.resultDisplay}`]?this.processedMappings[`default-${this.context?.resultDisplay}`]:this.processedMappings[t[this.resultField]]?this.processedMappings[t[this.resultField]]:this.processedMappings.default?this.processedMappings.default:void console.warn("No element mapping found for: ",t)}_getResults(){const t=this.context?.response?.search_results??[];return 0===t.length?null:ws`
    ...
    `}render(){return this.configLoaded?ws`${this._getResults()} `:null}};ys([E()],Ss.prototype,"resultField",void 0),ys([E({type:Object})],Ss.prototype,"mappings",void 0),ys([C()],Ss.prototype,"configLoaded",void 0),ys([C()],Ss.prototype,"processedMappings",void 0),Ss=ys([o("search-results")],Ss);var Os=function(t,s,e,i){for(var h,n=arguments.length,r=n<3?s:null===i?i=Object.getOwnPropertyDescriptor(s,e):i,o=t.length-1;o>=0;o--)(h=t[o])&&(r=(n<3?h(r):n>3?h(s,e,r):h(s,e))||r);return n>3&&r&&Object.defineProperty(s,e,r),r};let xs=class extends gt{constructor(){super(...arguments),this.settings={},this.data={}}render(){const t=this.settings.id,s=this.settings.title,e=this.settings.thumbnail,i=this.settings.fields,h=this.settings.base_path;let n=this.data[t],r=this.data[s],o=this.data[e];const l=i.split(",").map((t=>t));return Array.isArray(r)&&(r=r.map((t=>t.startsWith("[@")?t.split("]")[1]:t)),r=r.join(" | ")),Array.isArray(o)&&(o=o[0]),X`
      ...
      <ul>
        ${l.map((t=>"id"===t?X`<li hidden> ${this.data[t]} </li>`:X`<li> ${this.data[t]} </li>`))}
      </ul>
      <hr />
